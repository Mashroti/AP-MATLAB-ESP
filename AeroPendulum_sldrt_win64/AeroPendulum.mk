...
MAKECMD         = "C:/PROGRA~1/POLYSP~1/R2019a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := AeroPendulum
MODULES              := AeroPendulum_data.c AeroPendulum_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := AeroPendulum.mk
...
SLDRTDIR             := C:/PROGRA~1/POLYSP~1/R2019a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := AeroPendulumlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := AeroPendulum_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/Code/matlab/AeroPendulumMATLAB_esp;D:/Code/matlab/AeroPendulumMATLAB_esp/AeroPendulum_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
CPPSRCDIRS := $(RELATIVE_PATH_TO_ANCHOR) $(MATLAB_ROOT)/simulink/src D:/Code/matlab/AeroPendulumMATLAB_esp/AeroPendulum_sldrt_win64 $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
